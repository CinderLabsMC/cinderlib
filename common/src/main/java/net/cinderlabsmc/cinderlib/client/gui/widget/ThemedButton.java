...
public abstract class ThemedButton<Value> extends AbstractButton {
    ...
    protected ThemedButton(@NonNull Bounds bounds, @NonNull ICinderTheme theme, @NonNull List<Value> values, @NonNull Value initial, @NonNull Function<Value, Component> names, @NonNull Consumer<Value> onChange) {
    ...
    @Override
    protected final void extractContents(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
