...
public record ProgressBar(ICinderTheme theme, Bounds bounds, LongSupplier value, LongSupplier max, int color,
    BarDirection direction, Supplier<List<Component>> tooltip) implements IGuiElement {
