...
public final class IconButton<Value> extends ThemedButton<Value> {
    ...
    public IconButton(int left, int top, @NonNull ICinderTheme theme, @NonNull List<Value> values, @NonNull Value initial, @NonNull Function<Value, ItemStack> icons, @NonNull Function<Value, Component> names, @NonNull Consumer<Value> onChange) {
