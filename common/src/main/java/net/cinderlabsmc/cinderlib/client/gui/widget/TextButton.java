...
public final class TextButton<Value> extends ThemedButton<Value> {
    ...
    public TextButton(@NonNull Bounds bounds, @NonNull ICinderTheme theme, @NonNull List<Value> values, @NonNull Value initial, @NonNull Function<Value, Component> names, @NonNull Consumer<Value> onChange) {
