...
public abstract class CinderScreen<Menu extends AbstractContainerMenu> extends AbstractContainerScreen<Menu> {
  ...
  protected CinderScreen(@NonNull Menu menu, @NonNull Inventory inventory, @NonNull Component title, int width,
      int height) {
  ...
  public boolean keyPressed(@NonNull KeyEvent event) {
    if (event.key() == InputConstants.KEY_ESCAPE || !(getFocused() instanceof EditBox field)
