...
/**
 * Generic renderer for every {@link CinderGeoBlockEntity}: per-instance
 * model/texture and {@link CinderBones}
 * adjustments come from the block entity. Facing blocks are rotated by GeckoLib
 * automatically.
 */
public class CinderGeoBlockRenderer<T extends CinderGeoBlockEntity, R extends BlockEntityRenderState & GeoRenderState>
  ...
  @Override
  public void addRenderData(@NonNull T blockEntity, @Nullable Void relatedObject, @NonNull R renderState,
      float partialTick) {
